...
const publicSystems = pastWork.filter((project) => project.type.includes("Government") || project.type.includes("Design System"));
const activeWork = projects.filter((project) => project.status === "LIVE" || project.status === "ONLINE" || project.status === "IN PROGRESS");
